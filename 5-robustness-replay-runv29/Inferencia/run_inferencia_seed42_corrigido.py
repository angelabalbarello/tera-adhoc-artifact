...
SEED       = 42
T          = 96
THETA_TTD  = 0.10    # [FIX-1] limiar explícito, alinhado com o artigo
FRAME_THR  = 0.35    # [FIX-2] limiar de onset igual ao protocolo principal
KIN        = [12, 13, 14]   # índices cinemáticos — igual ao run_v29

# [FIX-3] Parâmetros de gating extraídos de exp_abl_A_results_all_seeds.csv
...
# [FIX-4] Usar split estratificado por recipe_id, igual ao run_v29
...
# [FIX-2] onset via FRAME_THR (= protocolo principal)
...
# [FIX-5] gating usa subconjunto cinemático KIN (igual ao run_v29)
# [FIX-6] delta = max sobre KIN (não mean sobre todos os features)
p_hibr  = []
gating  = []
y_prev  = 0.0
