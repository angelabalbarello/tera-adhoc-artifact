...
RECIPES_BORDERLINE: Dict[str, Dict[str, Any]] = {
    ...
    "L01": {
        "nome": "Alerta: Celular em velocidade urbana moderada",
        "categoria": "Alerta",
        # ESTADO_CELULAR a 20 km/h → v[16] = clip(20/40) ≈ 0.50
        # Intermediário entre Atenção (v[16]=0) e Crítico (v[16]=1.0 a 110km/h)
        # v[1]=1 (celular) sinaliza comportamento de risco ao modelo
        "risk_target": 0.60,
        "curve": "low_bump",
        "sequence": [
            ("ESTADO_NORMAL", 38, {"speed": 25, "traffic": "moderado",
                                   "is_urban": True}),
            ("ESTADO_CELULAR", 30, {"speed": 20, "traffic": "moderado",
                                    "is_urban": True}),
            ("ESTADO_NORMAL", 28, {"speed": 22, "traffic": "moderado"}),
        ],
    },
    "L02": {
        "nome": "Alerta: Pegar objeto em rodovia",
        "categoria": "Alerta",
        # ESTADO_PEGAR_OBJETO a 90 km/h.
        # Treino viu pegar_objeto como Crítico a 35-40 km/h (C04, C08).
        # A 90 km/h é objetivamente mais perigoso — modelo deve reagir.
        "risk_target": 0.72,
        "curve": "peak_then_drop",
        "sequence": [
            ("ESTADO_NORMAL",      55, {"speed": 90, "highway": True,
                                        "traffic": "livre"}),
            ("ESTADO_PEGAR_OBJETO", 18, {"speed": 88, "highway": True}),
            ("ESTADO_NORMAL",      23, {"speed": 90, "highway": True}),
        ],
    },
    "L03": {
        "nome": "Alerta: Grooming em rodovia",
        "categoria": "Alerta",
        # ESTADO_GROOMING a 90 km/h.
        # Treino viu grooming como Crítico a 108 km/h (C10).
        # A 90 km/h é velocidade similar — modelo deve reagir moderadamente.
        "risk_target": 0.68,
        "curve": "low_bump",
        "sequence": [
            ("ESTADO_NORMAL",  38, {"speed": 90, "highway": True,
                                    "traffic": "livre"}),
            ("ESTADO_GROOMING", 30, {"speed": 88, "highway": True}),
            ("ESTADO_NORMAL",  28, {"speed": 90, "highway": True}),
        ],
    },
}
