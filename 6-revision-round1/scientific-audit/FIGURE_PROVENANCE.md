...
|---|---|---|---|
| Figs. 4–6 | 4-fig_entropy_dist_en / 5-fig_temporal_trace_en / 6-fig_gating_heatmap_en | scientific-audit/scripts/regen_dense_figs_en_v2.py | 5-robustness-replay-runv29/Inferencia/episode_frame_logs_v2.csv (reconstruído por scripts/rebuild_episode_frame_logs_v2.py; verificar na GPU com generate_episode_frame_logs.py corrigido) |
